...
- **URL:** This is our webhook URL or build hook.
  ...
  ![Build-hooks](/images/docs/getting-started/webhooks-build-hooks.png)
...
![Webhook details](/images/docs/getting-started/webhooks-hygraph-ui.png)

Once saved, you should see your webhook on the main screen.

![Webhook on the main screen](/images/docs/getting-started/webhooks-build-to-netlify.png)
...
To setup a deployment to Vercel, follow our step-by-step guide on how to [deploy to Vercel using Hygraph Webhooks](/docs/guides/webhooks/trigger-static-build).

<Card theme="info" title="Quick Tip">

You can also setup static deployments to Netlify using our [Hygraph-Netlify Intergration](/docs/integrations/connect-netlify): This integration allows you to install a button in the Hygraph sidebar of a content model for manual redeploys, alongside a visual indicator of deployment status.
...
<Button
  href="/docs/getting-started/getting-started-wrap-up"
  size="md"
  variant="solid"
  theme="primary"
