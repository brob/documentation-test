...
![Webhooks](/images/getting-started/getting-started-webhooks.png)
...
- [Deploy your Vercel project](/guides/webhooks/trigger-static-build)
- [Deploy your Gatsby project](/guides/webhooks/deploy-gatsby-project)
