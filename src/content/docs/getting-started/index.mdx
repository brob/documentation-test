...
With our [Remote Sources](https://hygraph.com/guides/schema/remote-sources) feature, you can access remote content & data through the Hygraph GraphQL API, allowing you to create a single content endpoint without having to migrate everything to a single platform.
...
We offer industry leading Graph APIs for content delivery, mutations and content management, as well as a globally distributed infrastructure with [advanced caching](https://hygraph.com/api-reference/basics/caching).
...
![Project Dashboard](/images/user-guides/project-dashboard.png)
...
| Document                                                                        | Contents                                                                                                                                                                                                |
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [About Hygraph](/getting-started)                                          | Contains information about Hygraph, such as how it works, its advantages and use cases. It also offers information on how to navigate the CMS.                                                          |
| [Quickstart](/getting-started/fundamentals/quickstart)                     | Quickstart guide containing all basic mechanics involved in creating a project, a model, adding a basic field, creating a content entry, publishing/querying/mutating content, and enabling API access. |
| [Content modeling](/getting-started/fundamentals/content-modeling)         | Contains information about the basics of content modeling with Hygraph, and why it is important for all projects.                                                                                       |
| [Content Federation](/getting-started/fundamentals/content-federation)     | Contains information about what Content Federation is and its advantages.                                                                                                                               |
| [Migrating to Hygraph](/getting-started/fundamentals/migrating-to-hygraph) | Contains information about the process of migrating to Hygraph.                                                                                                                                         |
| [Glossary](/getting-started/fundamentals/glossary)                         | Contains lists of useful Hygraph related concepts and terms.                                                                                                                                            |
...
| [Wrap-up](/getting-started/configure-webhooks)                                  | This document contains a recap on our learning objectives, a list of best practices for your Hygraph projects, and some useful links so you can continue learning. |

### App walkthrough

| Document                                                                           | Contents                                                                                                                                                                         |
| ---------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Onboarding checklist](/getting-started/app-walkthrough/onboarding-checklist) | Contains information on the in-app onboarding checklist that walks you though your first steps in Hygraph                                                                        |
| [Schema editor](/getting-started/app-walkthrough/schema-editor)               | Contains information about the schema editor and how to set up content models in your project.                                                                                   |
| [Content editor](/getting-started/app-walkthrough/content-editor)             | Contains information on accessing existing content, creating custom content views, creating/editing/reviewing and publishing content.                                            |
| [Assets](/getting-started/app-walkthrough/digital-asset-manager)              | Contains information about how to manage and upload your assets.                                                                                                                 |
| [API Playground](/getting-started/app-walkthrough/api-playground)             | Contains information about Hygraph's API Playground, which you can use to test out API calls, by experimenting with querying and mutating data.                                  |
| [Notifications](/getting-started/app-walkthrough/notifications)               | Contains information about Hygraph's notifications feature, which informs you of comments assigned or related to you in content entries.                                         |
| [Apps](/getting-started/app-walkthrough/apps)                                 | Contains information about our Apps section, where you can manage Hygraph integrations with other apps. You can configure or uninstall apps from your project from this section. |
| [Webhooks](/getting-started/app-walkthrough/webhooks)                         | Contains information about how to add webhooks to your project's deployment according to triggers you can configure.                                                             |
| [Project settings](/getting-started/app-walkthrough/project-settings)         | Contains information about your project's global information, and about managing its settings.                                                                                   |
