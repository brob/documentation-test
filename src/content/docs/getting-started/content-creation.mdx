...
During schema building, we modified our **Assets** system model so the images would have alternative text and a caption. If we go to the **Assets** tab of our Hygraph project, we'll notice that already contains images. We've provided these images from the get go so you would't have to upload them yourself. If you're interested in learning more about asset upload, check out [this document](/docs/guides/assets/upload-asset).

Our assets table should look like this:

![Assets table with images](/images/docs/getting-started/assets-table-with-images.png)
...
[Here's the information you can use on the rest of the assets](/docs/getting-started/content-creation-additional-practice#assets)
...
![Product categories in the content editor](/images/docs/getting-started/product-category-table-empty.png)
...
![Product categories in the content editor - with entries](/images/docs/getting-started/product-category-table-full.png)
...
![Seller information content editor view with entry](/images/docs/getting-started/seller-information-table.png)
...
![Add product content entry](/images/docs/getting-started/add-product-content-entry.png)
...
![Product content entry](/images/docs/getting-started/product-content-entry.png)
...
[Here's the information you can use on the rest of the products](/docs/getting-started/content-creation-additional-practice#products)
...
![Component with related products](/images/docs/getting-started/related-products-component.png)
...
[Here's the information you can use on the rest of the products](/docs/getting-started/content-creation-additional-practice#related-products)
...
![Blog post complete entry](/images/docs/getting-started/blog-post-entry.png)
...
![Homepage complete entry](/images/docs/getting-started/full-homepage-entry.gif)
...
<Button
  href="/docs/getting-started/content-localization"
  size="md"
  variant="outlined"
  theme="primary"
