...
We also have a [Getting Started tutorial](/docs/getting-started/onboarding-overview) that covers these subjects - and more - in depth, where you can follow step-by-step lessons that will take you from project creation to frontend connection.
...
![Add a new project](/images/docs/getting-started/fundamentals/add-new-project-screen.png)
...
You can learn more about this in our [Caching](/docs/api-reference/basics/caching) documentation.

</Card>

### Blank project

![Blank new project](/images/docs/getting-started/fundamentals/new-project-blank.png)
...
![Starter new project](/images/docs/getting-started/fundamentals/new-project-starter.png)
...
![Creating a product model](/images/docs/getting-started/fundamentals/create-model.gif)
...
Every time we need to add a field, we will select one of the [field types](/docs/api-reference/schema/field-types) from the right sidebar of the schema builder.

Different field types may require for us to fill in different information.

In this Quickstart, we will add three fields to our **Product** model: One for product name, one for product price and one for product images. Check out our document on [field types](/docs/api-reference/schema/field-types) to learn more about all the types of fields you can add to your schema.

### Create a name field

![Creating a name field](/images/docs/getting-started/fundamentals/create-name-field.gif)
...
![Creating a price field](/images/docs/getting-started/fundamentals/create-price-field.gif)
...
![Creating an image field](/images/docs/getting-started/fundamentals/create-image-field.gif)
...
Would you like to know more? Check out our documentation on [working with assets](/docs/guides/assets/work-with-assets).

</Card>

### Explore system fields

By default, Hygraph handles system fields for things such as the `id`, `createdAt`, `publishedAt`, [and more](/docs/api-reference/schema/system-fields).

You can see all of the system fields for your selected model by clicking on `Show system fields`.

![Show system fields](/images/docs/getting-started/fundamentals/show-system-fields-toggle.png)

## Create a content entry

We will now add some content for our newly created `Product` model.

![Add entry](/images/docs/getting-started/fundamentals/add-entry-button.png)
...
![Entry in DRAFT stage](/images/docs/getting-started/fundamentals/entry-draft-stage.png)
...
[Click here to learn more about field validations](/docs/api-reference/schema/field-configuration#validations)
...
![Publish your content](/images/docs/getting-started/fundamentals/publish-content-entry.png)
...
Check out our document on [content stages](/docs/guides/content/content-stages) to learn more.
...
![Publish your entry & assets](/images/docs/getting-started/fundamentals/publish-entry-with-assets.gif)
...
![Outdated content entry](/images/docs/getting-started/fundamentals/outdated-content-entry.png)

<Card type="info" title="Pro Tip">

You can repeat publishing outdated entries either by clicking the `Publish` button again, or by [scheduling for later](/docs/guides/content/scheduled-publishing#how-to-schedule).
...
Check out out document on [content publishing](/docs/guides/content/publishing-content) for more information. 
...
You can try out all of the queries, and mutations your project has inside of the [API Playground](/docs/api-reference/basics/api-playground).

You can visit the API Playground by navigating to it from the sidebar:

![The API Playground](/images/docs/getting-started/fundamentals/api-playground.png)

If you begin to type inside of the API Playground `product` you will see autosuggest recommend some queries. We'll get the query to fetch a single product entry, multiple, an individual product version, and the [connection query](/docs/api-reference/content-api/queries#fetching-with-relay) to fetch edges/nodes.
...
You can explore our [API Reference](/docs/api-reference) to learn more about the API functionlity. This includes filtering, pagination, ordering, transforming image assets, and more.

Our [Getting Started tutorial](/docs/getting-started/onboarding-overview) offers the option to clone a project that you can use to practice queries.
...
![updateProduct mutation](/images/docs/getting-started/fundamentals/update-product-mutation.png)
...
Our [Getting Started tutorial](/docs/getting-started/onboarding-overview) offers the option to clone a project that you can use to practice mutations.

</Card>

## API Access

The last step, is to navigate to your `Project settings` panel to enable access to your API. You can either enable full public access to your API or [protect your API with permanent auth tokens.](/docs/api-reference/basics/authorization)
...
![Public content API permissions](/images/docs/getting-started/fundamentals/public-content-api-permissions.png)
...
![Content API URL](/images/docs/getting-started/fundamentals/content-api-url.png)

Run the query we used in the [Query content](/docs/getting-started/fundamentals/quickstart#query-content) section of this document once more. This is now publicly accessible on the web!

![Content publicly available](/images/docs/getting-started/fundamentals/content-publicly-available.png)

## Additional resources

| Document                                                             | About                                                                                                                                   |
| -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| [Getting Started](/docs/getting-started/onboarding-overview)         | Comprehensive project-based tutorial on how to create a Hygraph project from A to Z.                                                    |
| [API access](/docs/guides/overview/api-access)                       | Information on enabling API access.                                                                                                     |
| [Roles and permissions](/docs/guides/overview/roles-and-permissions) | Information on roles and permissions including system roles, custom roles, how to work with roles & permissions, and detailed examples. |
