...
![Content modeling with Hygraph](/images/docs/user-guides/content-modeling-with-hygraph.png)
...
![Movie content model](/images/docs/user-guides/movie-content-model.png)
...
![Environments flow](/images/docs/getting-started/environments-flow.png)
...
We recommend reading the documentation on [how to work with content permissions](/docs/guides/overview/roles-and-permissions).
...
Hygraph provides many different scalar types for things like Strings, Integers, Dates, Booleans, and even for things like Colors, and Geo coordinates. You can learn about the supported [field types](/docs/api-reference/schema/field-types) inside of the API Reference.
...
We recommend reading the API Reference for [Field Configuration](/docs/api-reference/schema/field-configuration#validations) to see which field modifiers are available, and how they are used.
