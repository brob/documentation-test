...
![Table showing content in stages DRAFT, PUBLISHED, & outdated](/images/getting-started/content-stages-comparison.png)

If you're interested in learning more about content stages and custom content stages, take a look at our [content stages documentation](/guides/content/content-stages).
...
![Save and Save & publish buttons](/images/getting-started/save-publish-options.png)

This is useful in workflows where content needs to be reviewed before publishing.

Want to learn more about publishing content? Check out our [documentation](/guides/content/publishing-content).
...
![Content duplication steps](/images/getting-started/duplicate_content.gif)
...
If the content entry contains reference fields, some of the relations will be duplicated, and others won't. The system will notify you if this is the case. Check out [our document on content duplication](/guides/content/duplicating-content) to learn more.
