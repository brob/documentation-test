...
![Your Asset model](/images/docs/getting-started/asset-model.png)
...
![Your Product model so far](/images/docs/getting-started/product-model-initial-fields.png)
...
![Product category model details](/images/docs/getting-started/product-category-model-details.png)
...
![Your Product category model so far](/images/docs/getting-started/product-category-model-fields.png)
...
![Product category in Rich Text embeds](/images/docs/getting-started/product-category-rich-text.png)
...
![Add model screen](/images/docs/getting-started/blog-post-model-details.png)
...
![Blog post model fields](/images/docs/getting-started/blog-post-model-fields.png)
...
![Seller information model details](/images/docs/getting-started/seller-information-model-details.png)
...
<Button
  href="/docs/getting-started/configure-reference-fields"
  size="md"
  variant="outlined"
  theme="primary"
