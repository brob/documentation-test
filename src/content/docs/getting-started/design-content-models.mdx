...
![Project structure](/images/docs/getting-started/hygraph-project-structure.png)
...
![Project models](/images/docs/getting-started/hygraph-project-models.png)
...
<Button
  href="/docs/getting-started/build-content-models"
  size="md"
  variant="outlined"
  theme="primary"
