...
![Adding enumerations](/images/getting-started/add-enumeration-screen.png)
...
![Clothes size enumeration](/images/getting-started/enumeration-clothes-size.png)
...
![Shoes size enumeration](/images/getting-started/enumeration-shoes-size.png)
...
![Wearable items color enumeration](/images/getting-started/enumeration-wearables-color.png)
...
![Decor items color enumeration](/images/getting-started/enumeration-decor-color.png)

After adding your **Enumerations** the left sidebar should look like this:

![Your enumerations listed in the schema](/images/getting-started/enumerations-listed.png)
...
<Button
  href="/getting-started/build-components"
  size="md"
  variant="outlined"
  theme="primary"
