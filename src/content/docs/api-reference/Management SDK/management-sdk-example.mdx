...
This document is a step by step of the example presented [here](/docs/api-reference/management-sdk/management-sdk-examples#create-different-field-types).
...
You will complete the authToken and endpoint using your project's data. [Read this document](/docs/getting-started/api-access) for further details.
