...
![submitBatchChanges mutation](/images/api-reference/developer-tools/managementsdk-createsimplefield.png)
...
- Take a look at our [Quickstart](/api-reference/management-sdk/management-sdk-quickstart).
- Learn more about the [Management SDK installation and usage](/api-reference/management-sdk/management-sdk-quickstart#installation).
- Learn how to [migrate from the old SDK](/api-reference/management-sdk/management-sdk-migration).
