...
Not all options are available for all [field types](/docs/api-reference/schema/field-types).
...
![Rich Text Options](/images/docs/api-reference/schema/rich-text-embed-options.png)

## Validations

Not all validation options are available for all [field types](/docs/api-reference/schema/field-types).
...
Not all advanced settings are available for all [field types](/docs/api-reference/schema/field-types).
...
| Hidden       | The field will not be shown in the UI, but can be referenced by other fields such as [Slugs](/docs/api-reference/schema/field-types#string), or [UI Extensions](/docs/ui-extensions). |
