...
[Learn more about working with multiple environments](/guides/overview/multiple-environments)

## Create environments

You can create environments using our UI by following [these steps](/guides/overview/manage-project-environments#create-an-environment).

## Switching environments

You can switch environments using our UI by following [these steps](/guides/overview/manage-project-environments#switch-environments).
...
Click [here](/guides/overview/manage-project-environments#promote-environments-to-master) for some extra information on how to use our UI to promote an environment to master.

## Delete an environment

You can delete environments using our UI by following [these steps](/guides/overview/manage-project-environments#delete-environments).
