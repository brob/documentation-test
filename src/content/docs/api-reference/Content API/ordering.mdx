...
You can order results by all [System Fields](/docs/api-reference/schema/system-fields#asset-fields), and any non-relational custom field you define in your model, either ascending, or descending.
